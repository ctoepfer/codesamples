...
Use this utility when you have been invited to test a Roku beta channel before
...
Installing a beta replaces the current sideloaded channel on the Roku. It does
not replace public Roku Channel Store apps.
