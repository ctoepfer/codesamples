...
The [hardware setup schematic](hardware-setup.svg) shows the physical study station and the three mutually exclusive EEG acquisition routes. Select **one** of the MindFlex/Arduino Brain, direct ThinkGear serial, or OpenBCI paths for a session, and select **one** gaze source. The editable D2 source is available as [hardware-setup.d2](hardware-setup.d2). Pinout, voltage-level, electrode-montage, and wireless-link requirements remain device- and revision-specific.

![PackScope hardware setup](https://private-us-east-1.manuscdn.com/sessionFile/J3rnMDshOBp9CTdud2WjJV/sandbox/ZxLXs6rZ240PZwh2jDhFw2-images_1789363544138_na1fn_L2hvbWUvdWJ1bnR1L3BhY2tzY29wZS9kb2NzL2hhcmR3YXJlLXNldHVw.png?Policy=_&Key-Pair-Id=K2QY5QTL8JSY6C&Signature=MEUCIQC-oTXbxwzVFMg2Oq6lnmjY48QfAKh6Q903x8HawpL8ygIgVRRp2d~02x8tdoMe~e9anK4P0kR5vpcica~K~b3qjQ8_)
